"""Seed DoorDash ML Domain Fundamentals rapid review + quick-fire Q&A prep doc into company_documents."""
import os
import sqlite3
...
DOC_TITLE = "DoorDash ML Domain Prep: ML Fundamentals Rapid Review + Quick-Fire Q&A"


def main() -> None:
    """Read the markdown doc and upsert into company_documents."""
    doc_path = os.path.join(DOCS_DIR, "doordash_ml_domain_fundamentals.md")
    ...
    conn.commit()
    conn.close()
    print("[DONE] DoorDash ML fundamentals prep doc seeded successfully")
