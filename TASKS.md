...
#### T-P0-180: Fix ruff lint errors (4x UP017 datetime.UTC)
- **Priority**: P0
- **Complexity**: S
- **Depends on**: None
- **Description**: 4 auto-fixable UP017 errors in system_design.py. Run ruff check --fix. Acceptance: ruff check src/backend/ passes clean.
