"""Seed DoorDash ML Domain Feature Engineering + DL Modules prep doc into company_documents."""
import os
import sqlite3
...
DOC_TITLE = "DoorDash ML Domain Prep: Feature Engineering + Deep Learning Modules for RecSys"


def main() -> None:
    """Read the markdown doc and upsert into company_documents."""
    doc_path = os.path.join(DOCS_DIR, "doordash_ml_domain_features_dl.md")
    ...
    conn.commit()
    conn.close()
    print("[DONE] DoorDash features + DL modules prep doc seeded successfully")
