...
company_id: 3
doc_kind: hub_doc
title: 'Google 2026-04-17 Prep Hub'
target_id: 53
---
# Google SWE III 面试 — Prep Hub

> **T-3 days countdown**. 统一入口：本文聚合所有 Round 1 / Round 2 / Coding 必要链接。
> 详细背景见 [Google 2026-04-17 Interview Prep Note](db://51) 与 [DNN Key Papers Gist](db://52).

## 日程 (Pacific Time, 2026-04-17 周五)

| 时段 | 类型 | 长度 |
|------|------|------|
| 13:00–13:45 | **Round 1 — ML Basics & Knowledge** | 45 min |
| 13:45–14:15 | 休息 / 复盘切换 | 30 min buffer |
| 14:15–15:00 | **Round 2 — BQ / Googleyness & Leadership** | 45 min |
...
- Zoom 提前 5 分钟加入；双屏：主屏视频 + 副屏 prep hub + 空白 scratch
- Mock 冲突一律让位，正式 Google 面试**优先级最高**
