"""Idempotent seed: Lyra therapy session with Jacqueline -- Session 8.

Source: Discord 2026-05-19 (msg 1506180349590241353).
  - Tuesday 2026-05-19, 2:00 PM PDT
  - Therapy with Jacqueline, Session 8
  - 50 min

Company: Lyra (id=25). Timezone: naive Pacific (PDT), per project convention.
This is a NEW distinct session row (not a reschedule of the 2026-05-14 12:00
session, id=67, which is a separate prior slot). Mirrors the prior Jacqueline
session pattern (id=17/37/38/60/67), last seeded by
scripts/_add_lyra_jacqueline_2026-05-14.py.
...
Run: python scripts/_add_lyra_jacqueline_2026-05-19.py
"""
...
SESSIONS = [
    {
        ...
        "scheduled_at": "2026-05-19 14:00:00",
        "description": (
            "Jacqueline Hurt-Coppola session -- Session 8. "
            "Tuesday 2026-05-19 2:00 PM PDT, 50 min. "
