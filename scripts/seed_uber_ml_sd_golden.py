"""Seed Uber ML System Design Golden Answers (Staff-Level) into company_documents.
...
Source: src/backend/seed_data/uber/ml_sd_golden.md (2 Staff-level Golden Answers:
Uber Eats restaurant recommendation + Budget-constrained promo recommendation
[uplift x Lagrangian]).

Locked decision: markdown-only doc in company_documents -- no system_designs
table dual-write (table currently 0 rows; out-of-scope per task spec).

Task: T-P0-630 ([UBER-VO-3])
"""
...
MD_PATH = PROJECT_ROOT / "src" / "backend" / "seed_data" / "uber" / "ml_sd_golden.md"

COMPANY_ID = 5  # Uber
DOC_TITLE = "Uber ML System Design Golden Answers (Staff-Level)"
DOC_KIND = "prep_note"
SOURCE_TYPE = "prep_doc"
IS_GOLDEN = 1
SOURCE_PATH = "src/backend/seed_data/uber/ml_sd_golden.md"
