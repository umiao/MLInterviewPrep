...
- Auto-dismiss after 4s, manual dismiss on click
- useToast() hook exported
- All existing mutation calls show toast on error
...
- Applied to Problems page filters as proof of concept
- Filters persist across navigation and browser back/forward
- useDebounce: generic debounce hook for search inputs and auto-save
- Both hooks in src/frontend/src/hooks/

#### T-P0-78: [B1] CJK font support + install recharts + react-markdown
- **Priority**: P0
- **Complexity**: S
- **Depends on**: None
- **Description**: AC:
...
- recharts and react-markdown installed (used in later batches)
- Chinese text renders correctly in existing UI
