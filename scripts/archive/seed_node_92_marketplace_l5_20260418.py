"""Seed: T-P1-512 -- Upgrade id=92 Marketplace & Logistics to L5 gold standard.

Rewrites framework_node id=92 (path='pillar3.marketplace_logistics') to the
canonical Appendix A Unified Template Skeleton from id=18. Preserves ALL
existing ML content (surge formula, ETA decomposition, Hungarian / batched
dispatch, H3/S2 geospatial, key metrics, Pareto multi-objective, simulation,
price elasticity, VRP batching, greedy dispatch code) -- relocates them as
nested ### sub-modules under Section 4 per Appendix A optional-sections rule.
...
Safety:
  ...
  4. Post-update structural guards: length window 9000-11500, title+marker
     check covering all 11 Appendix A required sections and key ML content
     markers (surge formula, Hungarian, ETA components).
"""
...
NODE_ID = 92
TITLE_GUARD = "# Marketplace & Logistics"

LEN_MIN = 9000
LEN_MAX = 11500

NEW_DESCRIPTION = """# Marketplace & Logistics (L5 Gold-Standard Design)
