...
## API 设计与数据流 (API Design & Data Flow)
...
## 容量估算与核心算法 (Capacity Estimation & Core Algorithms)
...
## production_constraints (2741 chars)

## 深度剖析: 规模与可靠性 (Deep Dive: Scale & Reliability)
...
## 面试官追问 (Interviewer Follow-up Q&A)
